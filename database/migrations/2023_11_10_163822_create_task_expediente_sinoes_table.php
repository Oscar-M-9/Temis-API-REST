...
class CreateTaskExpedienteSinoesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('task_expediente_sinoes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('task_expediente_sinoes');
    }
}
