...
class CreateFlujoAsociadoSupremasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('flujo_asociado_supremas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('flujo_asociado_supremas');
    }
}
