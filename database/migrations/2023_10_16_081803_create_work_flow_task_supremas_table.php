...
class CreateWorkFlowTaskSupremasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('work_flow_task_supremas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('work_flow_task_supremas');
    }
}
