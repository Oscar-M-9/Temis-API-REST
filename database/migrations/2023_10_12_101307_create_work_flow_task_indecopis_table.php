...
class CreateWorkFlowTaskIndecopisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('work_flow_task_indecopis', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('work_flow_task_indecopis');
    }
}
