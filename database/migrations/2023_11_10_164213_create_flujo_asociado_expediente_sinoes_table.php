...
class CreateFlujoAsociadoExpedienteSinoesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('flujo_asociado_expediente_sinoes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('flujo_asociado_expediente_sinoes');
    }
}
