    ...
    */
    ...
    public function viewTaskProceso(Request $request)
    {
        ...
        if ($id) {
            ...
            $stageCountEnProgreso = WorkFlowTaskSuprema::select('w1.*')
            ...
            $taskExpediente = TaskSuprema::where('flujo_activo', 'no')
                ->where('id_exp', $id)
