...
class EconomicExpensesController extends Controller
{
    //
    /*
     * ************************************************
    ...
    public function addEconomic(Request $request)
    {
        ...
        if ($dataUser->code_user = $exp->code_user) {
            ...
            EconomicExpenses::insert($newData);
    ...
    public function editEconomic(Request $request)
    {
        ...
        if ($dataUser->code_user = $exp->code_user) {
            ...
            EconomicExpenses::where('id', $id)->where('code_company', $dataUser->code_company)->update($newData);
    ...
    /**
     * @OA\Get(
     *     path="/api/poder-judicial/get-economic",
    ...
    public function getAllEconomic()
    {
        ...
        $economic = EconomicExpenses::join('expedientes', 'economic_expenses.id_exp', '=', 'expedientes.id')
            ...
            ->orderBy('economic_expenses.id', 'desc')
            ->where('economic_expenses.code_company', $dataUser->code_company)
            ->where('economic_expenses.id_exp', $idExp)
            ->get();
        return response()->json([
            'economic' => $economic,
        ]);
    ...
    public function uploadAttachedFiles(Request $request)
    {
        ...
        $economicExpense = EconomicExpenses::where('id', $idEconomic)
            ->where('id_exp', $idExp)
